...
pub use repositories::{
    ...
    StoredOpenid4vpVerificationEvidence, StoredRecoveryRoot, TenantDirectoryRepository,
    TenantResourceBinding, TenantResourceBindingDeactivate, TenantResourceRepository,
    TenantResourceState, TenantResourceStateCas, TokenIssuanceRepository, TokenRepository,
