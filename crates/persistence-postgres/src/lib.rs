...
pub use repositories::{
    ...
    ControllerSlotStatus, ControllerSlotSummary, FederationRepository, FreshSecurityAuditReceipt,
    GrantAuthorization, GrantRepository, IDENTITY_APPROVAL_TTL_SECONDS, IdentityApprovalError,
    InitialAdminBootstrapRepository, InitialAdminBootstrapState, InitialAdminClaimOutcome,
    IssuedIdentityApproval, IssuedOpenid4vpVerificationEvidence, IssuedRecoveryChallenge,
    ...
    MtlsTrustAnchorRepository, NewControllerSlot, NewOpenid4vpVerificationAttachment,
    NewOpenid4vpVerificationEvidence, NewRecoveryChallenge, NewRecoveryRoot,
    ...
    RecoveryRootSummary, RecoveryRotationError, RecoverySubmission, RotateControllerKey,
